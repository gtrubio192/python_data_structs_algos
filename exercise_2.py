...
my_list = [randint(25, 100) for num in range(200)]
print(my_list)
...
my_list = set(my_list) # replace the code to the left
...
comparison = my_tuple[1] == my_new_tuple[-1] # replace the code to the left
