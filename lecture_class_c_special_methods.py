...
enrolled in the {course} course")
    ...
    # __XYZ__ denote 'dunder' methods.
    # in this class context, these are methods that overwrite the inhereted methods
    def __len__(self):
        return len(self.courses)
    # repr returns how it looks like to instanciate object
    def __repr__(self):
        return f"Student('{self.first_name}','{self.last_name}',{self.courses})"
    # str: customize how you want your class to be printed
    def __str__(self):
